...
public static class DynamicServiceRegistrationExtensions
{
    public static IServiceCollection AddServices(this IServiceCollection services)
    {
        ...
        foreach (var transientService in transientServices.Where(a => a.Service is not null))
        {
        ...
        foreach (var scopedService in scopedServices.Where(a => a.Service is not null))
        {
    ...
    public static IServiceCollection RegisterAppSettings(this IServiceCollection services, IConfiguration config)
    {
        ...
        foreach (var type in servicetypes.Where(a => a.Service is not null))
        {
