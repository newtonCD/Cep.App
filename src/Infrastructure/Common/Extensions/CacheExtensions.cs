...
public static class CacheExtensions
{
    ...
    public static Task SetAsync(this IDistributedCache cache, string key, byte[] value, in CancellationToken token = default)
    {
        if (key == null)
        {
            throw new ArgumentNullException(nameof(key));
    ...
    public static Task SetStringAsync(this IDistributedCache cache, string key, string value, in CancellationToken token = default)
    {
        return cache.SetStringAsync(key, value, new DistributedCacheEntryOptions(), token);
    }

    public static Task SetStringAsync(this IDistributedCache cache, string key, string value, DistributedCacheEntryOptions options, in CancellationToken token = default)
    {
        if (key == null)
        {
            throw new ArgumentNullException(nameof(key));
    ...
    public static async Task<string> GetStringAsync(this IDistributedCache cache, string key, CancellationToken token = default)
    {
